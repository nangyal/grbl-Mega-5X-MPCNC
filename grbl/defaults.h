...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define UNIT_PER_REV_AXIS1 32.0 // 32mm
  #define DEFAULT_AXIS1_STEPS_PER_UNIT (MICROSTEPS_AXIS1*STEP_REVS_AXIS1/UNIT_PER_REV_AXIS1) // 25
  ...
  #define UNIT_PER_REV_AXIS2 32.0 // 32mm
  ...
  #define UNIT_PER_REV_AXIS3 4.0 // 4mm
  ...
  #define DEFAULT_AXIS3_MAX_TRAVEL 500.0 // mm


  #if N_AXIS > 3
    #if AXIS_4_NAME != AXIS_1_NAME && AXIS_4_NAME != AXIS_2_NAME && AXIS_4_NAME != AXIS_3_NAME
      #define DEFAULT_AXIS4_STEPS_PER_UNIT 2.222222 // Direct drive : (200 pas par tours * 1/16 microsteps)/360°
